...
var json = {
	...
	"reminder6": {
		"group": ["Group:", "Personal"],
		"remindTitle" : ["Reminder Title:", "Lunch with mom"],
		"dueDate"	: ["Due Date:", "2013-05-24"],
		"recurrence" : ["Recurrence:", "5"],
		"description" : ["Description:", "Meet at Portillos for lunch"]
		
	},
	"reminder7": {
		"group": ["Group:", "Work"],
		"remindTitle" : ["Reminder Title:", "Leadership Meeting"],
		"dueDate"	: ["Due Date:", "2013-05-28"],
		"recurrence" : ["Recurrence:", "6"],
		"description" : ["Description:", "Prep with scorecards"]
	...
	"reminder9": {
		"group": ["Group:", "Personal"],
		"remindTitle" : ["Reminder Title:", "Trip to Arkansas"],
		"dueDate"	: ["Due Date:", "2013-07-11"],
		"recurrence" : ["Recurrence:", "1"],
		"description" : ["Description:", "Going to Arkansas for my birthday!"]
